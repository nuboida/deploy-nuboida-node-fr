...
import { UserPlus, Building2, Lock, Mail, User, ArrowLeft, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.title && response.message) {
        localStorage.setItem('welcome_toast', JSON.stringify({
  ...
  return (
    <>
      <AuthLayout>
        ...
        <button
          type="button"
          onClick={() => navigate('/homeowner/sign-in')}
          className="btn btn-link text-white p-0 mb-3 d-flex align-items-center gap-2"
      ...
      {/* Logo/Icon */}
      <div className="d-flex justify-content-center mb-4 login-icon-wrapper" role="img" aria-label={PORTAL_LABELS.HOMEOWNER}>
      ...
      <div className="login-card">
        <div className="text-center d-flex flex-column">
          <h1 className="h2 text-gradient-primary mb-0">
            {LABELS.CREATE_HOMEOWNER_ACCOUNT}
          </h1>
          <span>
      ...
      <div className="mt-3 d-flex flex-column align-items-center">
        ...
        <button
          type="button"
          onClick={() => navigate('/resident/sign-up')}
          className="btn btn-link p-0"
        >
